...
sizeInfo drawButton(int16_t x, int16_t y, String str, const ImageDef image = {0}, bool invert = false, int tolerance = 2, int borderWidth = 1, uint16_t frColor = GxEPD_BLACK, uint16_t bgColor = GxEPD_WHITE, bool draw = true);
