...
void loopDiceApp()
{
    ...
    if (dUChange)
    {
        // While static would make it faster, as in not allocate on the stack all the time, keeping it static wastes memory all the time
        int16_t d2Verts[16][3] = {
