...
// Domain uses the same everything as InkField, becuase it's a cheap knockoff glitz to hell, 
// which uses the same day name system as Slate, so we share those functions
