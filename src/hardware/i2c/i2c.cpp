...
bool initI2C()
{
  if (initedI2C == false)
  {
    ...
    {
      // gpio_set_pull_mode(gpio_num_t(I2C_SDA_PIN), gpio_pull_mode_t::GPIO_PULLUP_ONLY);
      // gpio_set_pull_mode(gpio_num_t(I2C_SCL_PIN), gpio_pull_mode_t::GPIO_PULLUP_ONLY);
      Wire.setTimeout(100);
